...
function speakNumber(number) {  
    ...
    // ✅ Voice toggle check (SAFE)
    const toggleElement = document.getElementById("voice_toggle");
    if (toggleElement && !toggleElement.checked) return;

    const langElement = document.getElementById("language_select");
